...
{
    public partial class AcceptIdeaList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Ideas
            string sqlqueryIdea = "Select *  from EEIdea where Idea_State='0'";
            ...
            sqlconn.Close();
            //-----------------------------------
            sqlqueryIdea = "Select *  from EEIdea where Idea_State='1'";
            ...
            while (reader2.Read())
            {
                ...
                ListBox2.Items.Add(reader2["Idea_Id"].ToString());
